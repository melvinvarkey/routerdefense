...
def pdfReport(outputFile, genericCfg, ManagementPlaneMetrics, ControlPlaneMetrics, DataPlaneMetrics):
    ...
    report = []
    logo = "logo-router-defense.jpg"
    im = Image(logo)
    formatted_time = time.ctime()
    intro = """
    <font size=12>Some of those recommandations could not fit with your environment for any reason.
    </font>
    Project page: <a href='https://github.com/pello/routerdefense'>https://github.com/pello/routerdefense</a>
    """
    report.append(im)
