...
def htmlReport(outputFile,genericCfg, ManagementPlaneMetrics, ControlPlaneMetrics, DataPlaneMetrics):
    ...
    htmlHeader.append('\n')
    htmlHeader.append('<h1><a href="https://github.com/pello/routerdefense">Router <span>Defense</span></a></h1>')
    htmlHeader.append('\n')
    ...
    htmlHeader.append('\n')
    htmlHeader.append('Project page: <a href="https://github.com/pello/routerdefense">https://github.com/pello/routerdefense</a>')
    htmlHeader.append('\n')
    htmlHeader.append('<br />')
    htmlHeader.append('Document reference: ' + time.strftime("%d%b%Y-%H%M%S", time.localtime()) )
    htmlHeader.append('</p>')
    htmlHeader.append('\n')
